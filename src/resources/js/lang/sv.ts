...
export const svTranslations = {
  ...
  published: 'Published',
  saveAsCopy: 'Spara som kopia',
  saveAsCopyCheckbox: 'Spara detta möte som kopia (Skapar ett nytt möte)',
  saveAsNewMeeting: 'Spara som nytt möte',
  saving: 'Sparar...',
  search: 'Search',
